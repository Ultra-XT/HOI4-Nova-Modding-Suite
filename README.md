...
**A visual, crash-safe (still underwork) creation hub for Hearts of Iron IV mods.** Build focus trees, research, events, decisions, national spirits, characters, country setups, and a full map — without hand-writing a single line of Paradox script.
